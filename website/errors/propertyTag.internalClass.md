...
A `@property` PHPDoc tag references a class that is marked as `@internal`. Internal types are not part of the package's public API and may change or be removed without notice.
