...
The [`PHPStan\Analyser\Scope`](https://apiref.phpstan.org/2.0.x/PHPStan.Analyser.Scope.html) object can be used to get more information about the code, like types of variables, or current file and namespace.
