...
This is [the interface](https://apiref.phpstan.org/1.10.x/PHPStan.Rules.Constants.AlwaysUsedClassConstantsExtension.html) your extension needs to implement:
