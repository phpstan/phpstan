...
[Custom rules](/developing-extensions/rules) can be tested in a test case extended from [`PHPStan\Testing\RuleTestCase`](https://apiref.phpstan.org/1.11.x/PHPStan.Testing.RuleTestCase.html). A typical test can look like this:
