...
You can then choose your own ruleset by copying parts of the [level configuration files](https://github.com/phpstan/phpstan-src/tree/1.8.x/conf) from PHPStan sources, or include your own custom rules.
