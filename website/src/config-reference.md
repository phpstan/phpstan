...
When set to `true`, PHPStan reports exception types listed in `@throws` PHPDoc tags that are never actually thrown by the function or method. This check activates at [level](/user-guide/rule-levels) 4 and above.
