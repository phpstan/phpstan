...
* PHPStan-maintained [`functionMap.php`](https://github.com/phpstan/phpstan-src/blob/master/resources/functionMap.php), and [deltas](https://github.com/phpstan/phpstan-src/tree/master/resources) for different PHP versions
