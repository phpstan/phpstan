...
describe('WebsiteStack', () => {
	...
	it('creates the website-deploy role scoped to the 2.3.x branch via OIDC', () => {
				...
				Statement: Match.arrayWith([
					Match.objectLike({
						...
						Condition: {
							...
							StringLike: {
								'token.actions.githubusercontent.com:sub': 'repo:phpstan/phpstan:ref:refs/heads/2.3.x',
							},
						},
					}),
				]),
