	...
	public function dataParseIgnoreComment(): array
	{
		return [
			...
			'ignore message single line comment' => [
				'// phpstan-ignore-next-line-message Function doSomething not found.',
				true,
			],
			'ignore message single line comment - wrong message' => [
				'// phpstan-ignore-next-line-message Function doSomethingElse not found.',
				false,
			],
			...
			'ignore message multi line doc block comment' => [
				...
				' * Lorem ipsum' . PHP_EOL .
				' *' . PHP_EOL .
				' * phpstan-ignore-next-line-message Function doSomething not found.' . PHP_EOL .
				' */',
				true,
			],
			'ignore message pattern single line comment' => [
				'// phpstan-ignore-next-line-message-regexp Function [a-zA-Z]+ not found.',
				true,
			],
			'ignore message pattern single line comment - wrong pattern' => [
				'// phpstan-ignore-next-line-message-regexp Function [0-9]+ not found.',
				false,
			],
			...
			'ignore message pattern multi line doc block comment' => [
				...
				' * Lorem ipsum' . PHP_EOL .
				' *' . PHP_EOL .
				' * phpstan-ignore-next-line-message-regexp Function [a-zA-Z]+ not found.' . PHP_EOL .
				' */',
				true,
			],
		];
	...
	public function dataInvalidNodeType(): array
	{
		return [
			...
			'Class method node' => [
				...
				'commentText' => '// phpstan-ignore-next-line-message Function doSomething not found.',
			],
			'Function node' => [
				'node' => new Node\Stmt\Function_('someFunction'),
				'commentText' => '// phpstan-ignore-next-line-message-regexp ^Function [a-zA-Z]+ not found.$',
			],
		];
	}
