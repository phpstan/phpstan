		...
		return [
			...
			[
				...
				[
					...
					'childNodes' => \DOMNodeList::class . '&iterable<int, ' . \DOMNode::class . '>',
					'firstChild' => \DOMNode::class,
					'lastChild' => \DOMNode::class,
					'previousSibling' => \DOMNode::class,
					'nextSibling' => \DOMNode::class,
					'attributes' => \DOMNamedNodeMap::class . '&iterable<string, ' . \DOMAttr::class . '>',
					'namespaceURI' => 'string',
					'prefix' => 'string',
					'localName' => 'string',
					'baseURI' => 'string',
		...
		return [
			[
				...
				[
					...
					'systemId' => 'string',
					'name' => 'string',
					'entities' => \DOMNamedNodeMap::class . '&iterable<string, ' . \DOMEntity::class . '>',
					'notations' => \DOMNamedNodeMap::class . '&iterable<string, ' . \DOMNotation::class . '>',
					'ownerDocument' => \DOMDocument::class,
