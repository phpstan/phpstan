...
class ClosureReturnTypeRuleTest extends \PHPStan\Rules\AbstractRuleTest
{
	...
	{
		return new ClosureReturnTypeRule(new FunctionReturnTypeCheck(new \PhpParser\PrettyPrinter\Standard(), new RuleLevelHelper($this->createReflectionProvider(), true, false, true)));
	}
