...
class ReturnTypeRuleTest extends \PHPStan\Rules\AbstractRuleTest
{
	...
	{
		return new ReturnTypeRule(new FunctionReturnTypeCheck(new \PhpParser\PrettyPrinter\Standard(), new RuleLevelHelper($this->createReflectionProvider(), true, false, true)));
	}
