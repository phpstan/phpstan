...
class ReadingWriteOnlyPropertiesRuleTest extends \PHPStan\Rules\AbstractRuleTest
{
	...
	{
		return new ReadingWriteOnlyPropertiesRule(new PropertyDescriptor(), new PropertyReflectionFinder($this->createBroker()), new RuleLevelHelper(true), $this->checkThisOnly);
	}
