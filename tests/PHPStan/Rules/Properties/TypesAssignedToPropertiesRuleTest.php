...
class TypesAssignedToPropertiesRuleTest extends \PHPStan\Rules\AbstractRuleTest
{
	...
	{
		return new TypesAssignedToPropertiesRule(new RuleLevelHelper($this->createReflectionProvider(), true, false, true), new PropertyDescriptor(), new PropertyReflectionFinder());
	}
