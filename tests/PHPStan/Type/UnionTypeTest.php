	...
	public function dataAccepts(): array
	{
		return [
			...
			[
				new UnionType([
					new CallableType([
						new NativeParameterReflection('a', false, new IntegerType(), PassedByReference::createNo(), false),
						new NativeParameterReflection('a', false, new StringType(), PassedByReference::createNo(), false),
						new NativeParameterReflection('a', false, new StringType(), PassedByReference::createNo(), false),
						new NativeParameterReflection('a', false, new ArrayType(new MixedType(), new MixedType()), PassedByReference::createNo(), false),
