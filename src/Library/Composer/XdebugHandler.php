...
namespace PHPStan\Library\Composer;

use PHPStan\Library\Composer\Util\IniHelper;
...
class XdebugHandler
{
    const ENV_ALLOW = 'PHPSTAN_ALLOW_XDEBUG';
    const ENV_VERSION = 'PHPSTAN_XDEBUG_VERSION';
    ...
    /**
     * Checks if xdebug is loaded and phpstan needs to be restarted
     *
     ...
     *
     * This behaviour can be disabled by setting the PHPSTAN_ALLOW_XDEBUG
