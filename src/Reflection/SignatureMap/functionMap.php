...
'DOMDocument::getElementsByTagName' => ['DOMNodeList&iterable<int,DOMElement>', 'name'=>'string'],
'DOMDocument::getElementsByTagNameNS' => ['DOMNodeList&iterable<int,DOMElement>', 'namespaceuri'=>'string', 'localname'=>'string'],
...
'DOMElement::getElementsByTagName' => ['DOMNodeList&iterable<int,DOMElement>', 'name'=>'string'],
'DOMElement::getElementsByTagNameNS' => ['DOMNodeList&iterable<int,DOMElement>', 'namespaceuri'=>'string', 'localname'=>'string'],
...
'DOMXPath::query' => ['DOMNodeList&iterable<int,DOMNode>', 'expression'=>'string', 'contextnode='=>'DOMNode', 'registernodens='=>'bool'],
