...
class Scope
{
    ...
    private function resolveType(Expr $node): Type
    {
        ...
        if ($node instanceof \PhpParser\Node\Expr\BinaryOp\BooleanAnd
            ...
            if ($leftBooleanType instanceof ConstantBooleanType
            ...
            if ($rightBooleanType instanceof ConstantBooleanType
        ...
        if ($node instanceof Node\Expr\BinaryOp\Plus
            ...
            if ((new FloatType())->isSuperTypeOf($leftNumberType)->yes()
    ...
    public function removeVariables(self $otherScope, bool $all): self
    {
        ...
        foreach ($otherScope->moreSpecificTypes as $exprString => $theirTypeHolder) {
            if ($all) {
                if (isset($ourTypeHolders[$exprString])
